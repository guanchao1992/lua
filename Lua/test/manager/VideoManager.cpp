...
void VideoManager::LoadContent()
{
	...
	{
		XMFLOAT3(0.7f, 0.7f, 0.5f),		XMFLOAT3(0.7f, 0.7f, 0.5f),
		XMFLOAT3(0.7f, 0.0f, 0.5f),		XMFLOAT3(0.7f, 0.7f, 0.5f),
		XMFLOAT3(0.0f, 0.7f, 0.5f),		XMFLOAT3(0.7f, 0.7f, 0.5f),

		XMFLOAT3(-0.8f, -0.7f, 0.5f),	XMFLOAT3(0.7f, 0.7f, 0.5f),
		XMFLOAT3(-0.7f, 0.0f, 0.5f),	XMFLOAT3(0.7f, 0.7f, 0.5f),
		XMFLOAT3(0.0f, -0.7f, 0.5f)	,	XMFLOAT3(0.7f, 0.7f, 0.5f)
	};
	//
	...
	{
		XMFLOAT3(0.9f, 0.9f, 0.5f),XMFLOAT3(0.f, 0.7f, 0.5f),
		XMFLOAT3(0.7f, 0.0f, 0.5f),XMFLOAT3(0.7f, 0.7f, 0.5f),
		XMFLOAT3(0.0f, 0.7f, 0.5f),XMFLOAT3(0.7f, 0.7f, 0.f)
	};
